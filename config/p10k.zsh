# Generated by Powerlevel10k configuration wizard on 2024-12-29 at 23:07 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #r#benv                   # ruby version from rbenv (https://github.com/rbenv/rbenv)
    #r#vm                     # ruby version from rvm (https://rvm.io)
    #f#vm                     # flutter version management (https://github.com/leoafarias/fvm)
    #l#uaenv                  # lua version from luaenv (https://github.com/cehoffman/luaenv)
    #j#env                    # java version from jenv (https://github.com/jenv/jenv)
    #plenv                   # perl version from plenv (https://github.com/tokuhirom/plenv)
    #perlbrew                # perl version from perlbrew (https://github.com/gugod/App-perlbrew)
    #p#hpenv                  # php version from phpenv (https://github.com/phpenv/phpenv)
    #s##calaenv                # scala version from scalaenv (https://github.com/scalaenv/scalaenv)
